...
- `2026-06-06`: Strengthened [Agent Workflow Bench](https://github.com/benben951/agent-workflow-bench) with summary JSON, recruiter-readable Markdown reports, evidence coverage, risk flags, human-takeover metrics, and public failing-sample artifacts from run manifests.
